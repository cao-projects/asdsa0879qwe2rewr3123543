...
driver.find_element(By.XPATH, txt_size_color_xpath).send_keys("medium red")
...
exp_warn_message = "This is a required question"
act_warn_message = driver.find_element(By.XPATH, "//*[@id='i51']").text
