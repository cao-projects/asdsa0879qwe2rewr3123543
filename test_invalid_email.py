...
act_warn_message = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, email_warn_xpath))).text

exp_warn_message = "Please enter an email address in the correct format"

# Assertion

if act_warn_message.strip() == exp_warn_message:
    print("Test Passed")
    assert True
else:
    print("Test Failed")
